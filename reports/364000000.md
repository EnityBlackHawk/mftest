# Migration Report
**Date:** Sat Apr 26 13:13:34 BRT 2025 
## Inputs:
|           Parameter |              Value |
|                 :-- |               :--: |
...
**LLM Model:** o4-mini 
### LLM Explanation
We embed static, frequently joined reference data (venue and eventcategory in events; seller info in listings; event name and date parts in sales) to optimize the most common queries, while preserving references for less-frequently joined or frequently updated entities to maintain consistency. 
<details>
<summary>
...
[
  ...
  },
  {
    ...
    "isId": false,
    "title": "listing",
    "description": "Ticket listings with embedded seller",
    "isAbstract": false,
    "relationshipType": "none",
    "properties": {
      "seller": {
  ...
  },
  {
    ...
    "isId": false,
    "title": "sales",
    "description": "Sales transactions with embedded event and date parts",
    "isAbstract": false,
    "relationshipType": "none",
    "properties": {
      "listid": {
      ...
      "date": {
        "type": "object",
        "isId": false,
        "description": "Embedded date parts",
        "isAbstract": false,
        "column": "dateid",
        "table": "sales",
        "relationshipType": "embedded",
