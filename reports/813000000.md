# Migration Report
**Date:** Fri May 02 09:16:54 BRT 2025 
## Inputs:
|           Parameter |              Value |
|                 :-- |               :--: |
...
**LLM Model:** o4-mini 
### LLM Explanation
All collections use references for foreign keys to optimize join-heavy queries while keeping flat documents. Primary keys are strings, and each referenceTo matches relational foreign-key relationships to support frequent access patterns without embedding. 
<details>
<summary>
...
[
  {
    ...
    "isId": false,
    "title": "date",
    "description": "Calendar dates dimension",
    "isAbstract": false,
  ...
  },
  {
    ...
    "isId": false,
    "title": "event",
    "description": "Events happening at venues",
    "isAbstract": false,
    "relationshipType": "none",
    "properties": {
      "catid": {
  ...
  },
  {
    ...
    "isId": false,
    "title": "listing",
    "description": "Ticket listings for events",
    "isAbstract": false,
    "relationshipType": "none",
    "properties": {
      "eventid": {
