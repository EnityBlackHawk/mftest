# Migration Report
**Date:** Sat Apr 26 11:52:36 BRT 2025 
## Inputs:
|           Parameter |              Value |
|                 :-- |               :--: |
...
**LLM Model:** o4-mini 
### LLM Explanation
Related entities are embedded following query hotspots: events embed venue, category, and date to optimize event queries; listings embed seller and event summary (with category) for fast listing and user-specific lookups; sales embed event and date summaries for efficient aggregations. Core tables (venue, eventcategory, date, users) are maintained as collections for updates but not referenced at query time. 
<details>
<summary>
...
[
  {
    ...
    "isId": false,
    "title": "event",
    "description": "Event with embedded venue, category, and date for query optimization",
    "isAbstract": false,
  ...
  },
  {
    ...
    "isId": false,
    "title": "eventcategory",
    "description": "Event category metadata",
    "isAbstract": false,
    "relationshipType": "none",
    "properties": {
      "catid": {
  ...
  },
  {
    ...
    "isId": false,
    "title": "date",
    "description": "Calendar date information",
    "isAbstract": false,
    "relationshipType": "none",
    "properties": {
      "caldate": {
  ...
  },
  {
    ...
    "isId": false,
    "title": "listing",
    "description": "Ticket listings with embedded seller and event details",
    "isAbstract": false,
    "relationshipType": "none",
    "properties": {
      "listid": {
  ...
  },
  {
    ...
    "isId": false,
    "title": "sales",
    "description": "Completed sales with embedded event and date details",
    "isAbstract": false,
    "relationshipType": "none",
    "properties": {
      "date": {
