# Migration Report
**Date:** Sat Apr 26 13:52:05 BRT 2025 
## Inputs:
|           Parameter |              Value |
|                 :-- |               :--: |
...
**LLM Model:** o4-mini 
### LLM Explanation
We embedded dimension data (venue, category, event, user minimal info, date month/year) into the core documents where join patterns and stability justify denormalization, while still maintaining references for lookup where heavy reuse or larger data exists. This design optimizes the frequent queries by making documents self-contained for filter, sort, and aggregation paths. 
<details>
<summary>
...
[
  {
    ...
    "isId": false,
    "title": "event",
    "description": "Events with embedded venue and category info",
    "isAbstract": false,
  ...
  },
  {
    ...
    "isId": false,
    "title": "listing",
    "description": "Listings with embedded seller and event info",
    "isAbstract": false,
    "relationshipType": "none",
    "properties": {
      "listid": {
  ...
  },
  {
    ...
    "isId": false,
    "title": "sales",
    "description": "Sales with embedded event and date info",
    "isAbstract": false,
    "relationshipType": "none",
    "properties": {
      "date": {
