# Migration Report
**Date:** Mon Apr 28 22:09:47 BRT 2025 
## Inputs:
|           Parameter |              Value |
|                 :-- |               :--: |
...
**LLM Model:** o4-mini 
### LLM Explanation
We embed small stable entities (venue and category) inside events to optimize query patterns filtering by city or category and avoid additional lookups. We reference larger or frequently changing data (users, date) and denormalize only minimal user info (username) into listings for fast sorting and lookup, while embedding event summary in sales for efficient analytics. 
<details>
<summary>
...
[
  {
    ...
    "properties": {
      ...
      "likefestivals": {
        "type": "boolean",
        "isId": false,
        "description": "Preference festivals",
        "isAbstract": false,
      ...
      "liketheater": {
        "type": "boolean",
        "isId": false,
        "description": "Preference theater",
        "isAbstract": false,
        "column": "liketheater",
        "table": "users",
        "relationshipType": "none",
      ...
      "likeconcerts": {
        "type": "boolean",
        "isId": false,
        "description": "Preference concerts",
        "isAbstract": false,
        "column": "likeconcerts",
        "table": "users",
        "relationshipType": "none",
  ...
  },
  {
    ...
    "isId": false,
    "title": "event",
    "description": "Event collection with embedded venue and category",
    "isAbstract": false,
    "relationshipType": "none",
    "properties": {
      "date": {
  ...
  },
  {
    ...
    "isId": false,
    "title": "listing",
    "description": "Listings of tickets",
    "isAbstract": false,
    "relationshipType": "none",
    "properties": {
      "seller": {
        "type": "object",
        "isId": false,
        "description": "Embedded seller summary",
        "isAbstract": false,
        "column": "sellerid",
        "table": "listing",
        "relationshipType": "embedded",
